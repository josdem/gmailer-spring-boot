...
public class SwaggerConfig {
    ...
    public OpenAPI appInfo() {
        Server prod = new Server().url("https://gmailer.josdem.io/").description("Production App link");

        Server dev = new Server().url("http://localhost:8083/").description("Development App link");

        // TODO confirm your contacts
        Contact contact = new Contact().name("Jose Morales").email("contact@josdem.io").url("https://josdem.io");
